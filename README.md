...
| ------------------- | ------------------- | ------------ |
| **Actualiza conceptos y conocimientos necesarios para su desarrollo profesional y en especial para su proyecto en soluciones de software.** | **Cabanillas Meza, José Mateo** <br><br> **TB1:** Durante el desarrollo del proyecto, actualize mis conocimientos investigando y aplicando metodologías como Lean UX y técnicas de análisis de requerimientos, lo que me permitió mejorar la calidad de mis aportes y adaptarme a las necesidades del sistema. <br><br> **TP:** Investigué a fondo los patrones de diseño de software y el modelado C4 para la arquitectura del sistema, lo cual me facilitó estructurar adecuadamente los diagramas de contenedores y componentes en esta etapa. <br><br> **TB2:** Profundicé en el desarrollo de microservicios con NestJS y la configuración de bases de datos PostgreSQL, aplicando técnicas de validación y manejo de errores para garantizar endpoints robustos. <br><br> **TF:** Actualicé mis conocimientos sobre Domain-Driven Design (DDD) y pruebas unitarias/de integración automatizadas, logrando refactorizar los microservicios core para cumplir con altos estándares de calidad. <br><br> **Nakasone Gomes, Marco Antonio** <br><br> **TB1:** Actualicé mis conocimientos incorporando nuevas herramientas y enfoques en el desarrollo de software, lo que me ayudó a contribuir de manera más efectiva en el proyecto y mejorar la toma de decisiones. <br><br> **TP:** Adquirí conocimientos en la especificación de escenarios "To-Be" e historias de usuario con criterios de aceptación claros, lo que mejoró el diseño funcional and la priorización del Product Backlog. <br><br> **TB2:** Actualicé mis habilidades técnicas al aprender a implementar comunicación asíncrona entre microservicios mediante brokers de mensajería (RabbitMQ/Kafka), logrando desacoplar los servicios de eventos y notificaciones. <br><br> **TF:** Estudié a detalle las tácticas de arquitectura de software para atributos de calidad y seguridad web, aplicando estrategias de hardening en la API y el pipeline de CI/CD del proyecto. <br><br> **Carhuancote Domminguez, Gonzalo Alonso** <br><br> **TB1:** Durante el proyecto, reforcé y actualicé mis conocimientos en análisis y diseño de soluciones, aplicando conceptos que permitieron estructurar mejor el desarrollo del sistema. <br><br> **TP:** Amplié mis conocimientos en diseño de bases de datos relacionales y no relacionales, permitiéndome optimizar el esquema relacional de NextHappen para soportar búsquedas por geolocalización eficientes. <br><br> **TB2:** Aprendí y apliqué conceptos avanzados de frontend usando Next.js y Tailwind CSS para implementar una interfaz responsiva, conectada en tiempo real a los microservicios backend. <br><br> **TF:** Investigué metodologías de despliegue continuo en la nube y configuración de contenedores Docker, logrando orquestar de manera autónoma los microservicios del proyecto final para producción. | Demostramos una evolución constante en nuestras competencias durante el desarrollo del proyecto. A través de la actualización y aplicación de conocimientos en metodologías, herramientas y enfoques de análisis y diseño, logramos fortalecer la calidad de nuestros aportes individuales. Esto permitió no solo una mejor estructuración del sistema, sino también una toma de decisiones más acertada y una mayor capacidad de adaptación a los requerimientos del proyecto, evidenciando un trabajo colaborativo orientado a la mejora continua. |
| **Reconoce la necesidad del aprendizaje permanente para el desempeño profesional y el desarrollo de proyectos en soluciones de software.**  | **Cabanillas Meza, José Mateo** <br><br> **TB1:** Reconocí la importancia del aprendizaje continuo al identificar mis brechas de conocimiento y buscar información para resolverlas, entendiendo que es clave para mi desarrollo profesional en software. <br><br> **TP:** Comprendí que el diseño arquitectónico evoluciona constantemente, por lo que decidí capacitarme de manera continua en arquitecturas limpias para mantener la consistencia técnica de las entregas. <br><br> **TB2:** Identifiqué que los estándares de desarrollo web exigen una actualización continua, lo cual me motivó a indagar activamente en buenas prácticas de codificación limpia en TypeScript. <br><br> **TF:** Reconocí la importancia de la mejora continua y el aprendizaje autónomo al capacitarme en herramientas de monitoreo y logging para sistemas distribuidos, asegurando la mantenibilidad a largo plazo. <br><br> **Nakasone Gomes, Marco Antonio** <br><br> **TB1:** Comprendí que el aprendizaje permanente es necesario, por lo que investigué constantemente para fortalecer mis habilidades y adaptarse a los cambios del entorno tecnológico. <br><br> **TP:** Asumí el reto del aprendizaje continuo al investigar metodologías ágiles y Scrum para la gestión ágil del equipo, reconociendo que la auto-organización es clave en el desarrollo profesional. <br><br> **TB2:** Ante la necesidad de asegurar la integridad del sistema, investigué de forma autónoma sobre pruebas de API y testing suites, adaptándome a las exigencias técnicas del proyecto. <br><br> **TF:** Entendí que la seguridad en software requiere educación constante, por lo que estudié vulnerabilidades comunes (OWASP Top 10) para implementarlas y mitigarlas en nuestro backend. <br><br> **Carhuancote Domminguez, Gonzalo Alonso** <br><br> **TB1:** Entendí que debo seguir aprendiendo continuamente, por lo que busqué nuevas fuentes de información para mejorar mi desempeño y enfrentar futuros retos profesionales. <br><br> **TP:** Reconocí que el manejo de base de datos requiere constante adaptación a nuevos patrones de persistencia, motivándome a estudiar técnicas de indexación avanzada para el Trabajo Parcial. <br><br> **TB2:** Descubrí brechas en mi manejo de arquitecturas de componentes reactivos, lo que me impulsó a tomar cursos autónomos sobre hooks y estado global en Next.js para mejorar el frontend. <br><br> **TF:** Comprendí que las tecnologías cloud y DevOps cambian con rapidez, decidiendo capacitarme en herramientas de automatización de despliegue para asegurar la viabilidad del TF. | Coincidimos en reconocer la importancia del aprendizaje continuo como un pilar fundamental en nuestra formación profesional. A partir de la identificación de nuestras propias brechas de conocimiento, cada uno de nosotros asumió una actitud proactiva al investigar y adquirir nuevas habilidades, lo que nos permitió mejorar nuestro desempeño y adaptarnos a las exigencias del entorno tecnológico. Esta mentalidad de mejora constante no solo fortalece nuestras capacidades actuales, sino que también nos prepara para afrontar con mayor solidez los retos futuros en el ámbito del desarrollo de software. |
...
- [Capítulo V: Product Implementation, Validation & Deployment](#capítulo-v-product-implementation-validation--deployment)
  ...
  - [5.3 Microservices Implementation](#53-microservices-implementation)
    - [5.3.1 Sprint 1](#531-sprint-1)
      - [5.3.1.1 Sprint Planning 1](#5311-sprint-planning-1)
      - [5.3.1.2 Sprint Backlog 1](#5312-sprint-backlog-1)
      - [5.3.1.3 Development Evidence for Sprint Review](#5313-development-evidence-for-sprint-review)
      - [5.3.1.4 Testing Suite Evidence for Sprint Review](#5314-testing-suite-evidence-for-sprint-review)
      - [5.3.1.5 Execution Evidence for Sprint Review](#5315-execution-evidence-for-sprint-review)
      - [5.3.1.6 Microservices Documentation Evidence for Sprint Review](#5316-microservices-documentation-evidence-for-sprint-review)
      - [5.3.1.7 Software Deployment Evidence for Sprint Review](#5317-software-deployment-evidence-for-sprint-review)
      - [5.3.1.8 Team Collaboration Insights during Sprint](#5318-team-collaboration-insights-during-sprint)
      - [5.3.1.9 Kanban Board](#5319-kanban-board)
